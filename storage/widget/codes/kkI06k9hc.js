...
let  iframe ;
var adtype = "InView";
var codeid = "kkI06k9hc";
var videofornat = "OUTSTREAM VIDEO PLAYER";
var domainurl = "https://www.instagram.com/aleksandra_kalinowska/";
var tagurl = "[tagurl]";
var codeid = "kkI06k9hc";
var addcontainer;
...
$(document).ready(function () {
    ...
    var containerAttr = container.getAttribute('id');
    console.log(containerAttr);

    switch (containerAttr) {
        case 'videomill-Sticky':
            console.log('I am sticky')
            $(document).scroll(function () {
                console.log("scroll");

                var inviewTop = $("#videomill-Sticky").offset().top;
                ...
                if (inviewTop > scrollTop) {
                    ...
                    $(".addcontainer").css("width", "100%");
                } else {
                    $(".addcontainer").css("position", "fixed");
                    $(".addcontainer").css("right", "0px");
                    $(".addcontainer").css("bottom", "0px");
                    $(".addcontainer").css("width", "40%");
                }
