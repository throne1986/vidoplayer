(function(global, factory) {
    ...
    PlayerWrapper.prototype.onAllAdsCompleted = function() {
       var out_sticky =window.parent.$("#videomill-Sticky");
       out_sticky.remove();

       var out_page =window.parent.$("#videomill-InPage");
       out_page.remove();

       var out_view =window.parent.$("#videomill-InView");
       out_view.remove();

       var out_inpage =window.parent.$("#videomill-InApp");
       out_inpage.remove();
       
       var out_inbanner =window.parent.$("#videomill-InBanner");
       out_inbanner.remove();
