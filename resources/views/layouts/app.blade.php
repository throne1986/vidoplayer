...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('Videomill Dashboard') }}</title>
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('material') }}/img/apple-icon.png">
    <link rel="icon" type="image/png" href="https://www.interactive-video.videomill.pl/images/fav_videomill_1.png">
        ...
        <div class="fixed-plugin">
          <div class="dropdown show-dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="button-container">
                <a href="https://videommerce.com//product/material-dashboard-pro-laravel" target="_blank" class="btn btn-danger btn-block btn-round">
                  Upgrade to PRO
                </a>
              </li>
